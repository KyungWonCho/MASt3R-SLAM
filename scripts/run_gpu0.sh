#!/bin/bash
# 7-Scenes vanilla + ablation eval, GPU 0 share.
# Scenes: chess (light) + redkitchen (heavy).
# Variants: vanilla, calibonly, caponly, calibcap, fusion.
# Idempotent: skips scenes whose trajectory file already exists.

set -u
export CUDA_VISIBLE_DEVICES=0
SCENES="chess redkitchen"
VARIANTS="vanilla calibonly caponly calibcap fusion"
